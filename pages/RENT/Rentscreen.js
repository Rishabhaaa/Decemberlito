      ...
      return(
        ...
        <ScrollView>
            ...
            <View style={{flexDirection:"row",padding:20}}>
                <TouchableOpacity disabled={true}><Text>Home > Shop >  </Text></TouchableOpacity>
                <TouchableOpacity onPress={()=>this.props.navigation.navigate('Home')}><Text style={{color:"#000",fontWeight:"bold"}}>Rent</Text></TouchableOpacity>
                </View>
                <Offerheader/>
